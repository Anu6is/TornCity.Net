...
Public Class FactionSelector
    ...
    Public Sub New(ParamArray selections() As FactionSelection)
    ...
    Public Function WithRange(timeFrom As DateTimeOffset, Optional timeTo? As DateTimeOffset = Nothing) As FactionSelector
